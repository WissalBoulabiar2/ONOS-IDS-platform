    ...
    <div className="p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-cyan-700 px-4 py-2 text-sm text-white hover:bg-cyan-600 transition-colors"
          >
      ...
      <div className="mb-6 grid grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-4">
          <p className="text-sm text-cyan-400">Managers</p>
          <p className="mt-1 text-2xl font-bold text-white">
            {users.filter(u => u.role === 'manager').length}
          </p>
        </div>
        <div className="rounded-2xl border border-slate-600/20 bg-slate-800/30 p-4">
          <p className="text-sm text-slate-400">Viewers</p>
          <p className="mt-1 text-2xl font-bold text-white">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl bg-cyan-700 px-4 py-2 text-sm text-white hover:bg-cyan-600 disabled:opacity-50"
                >
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-800">
          <table className="w-full text-sm">
            <thead className="bg-slate-800/50">
              <tr>
                <th className="px-5 py-3 text-left text-xs text-slate-400">User</th>
                <th className="px-5 py-3 text-left text-xs text-slate-400">Role</th>
                <th className="px-5 py-3 text-left text-xs text-slate-400">Status</th>
                <th className="px-5 py-3 text-left text-xs text-slate-400">MFA</th>
                <th className="px-5 py-3 text-left text-xs text-slate-400">Last Login</th>
                <th className="px-5 py-3 text-left text-xs text-slate-400">Actions</th>
              </tr>
            </thead>
                ...
                <tr key={u.id} className="hover:bg-slate-800/30">
                  ...
                  <td className="px-5 py-4">
                    <span className={`flex items-center gap-1 text-xs ${
                      u.mfa_enabled ? 'text-green-400' : 'text-slate-500'
                    }`}>
