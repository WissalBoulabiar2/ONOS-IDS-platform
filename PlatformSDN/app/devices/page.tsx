...
export default function DevicesPage() {
  ...
  const mapApiDevice = useCallback(
    (device: ApiDevice, portCount?: number): Device => {
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              Review SDN switches and routers, inspect availability, and prepare this inventory view
              for backend-driven details such as live ports, metrics, and flow context.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur lg:min-w-[300px]">
            ...
            <p className="text-2xl font-semibold">
              {offlineCount > 0
                ? `${offlineCount} device(s) offline`
                : 'All discovered devices reachable'}
            </p>
        ...
        <Card className="border-gray-200 bg-white/80 shadow-sm dark:border-gray-800 dark:bg-gray-900/80">
          <CardContent className="pt-6">
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-white">
              {devices.length > 0 ? ((onlineCount / devices.length) * 100).toFixed(0) : '0'}%
            </p>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          ...
          <Card className="border-gray-200 bg-white/80 shadow-sm dark:border-gray-800 dark:bg-gray-900/80">
            <CardContent className="pt-6">
              <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  Filter by status or type, then open the details panel to inspect ports and traffic
                  charts.
                </p>
              </div>
              <DeviceTable
        ...
        <div className="space-y-6">
          ...
          <Card className="border-gray-200 bg-white/80 shadow-sm dark:border-gray-800 dark:bg-gray-900/80">
            <CardContent className="pt-6 text-sm text-gray-600 dark:text-gray-400">
              ...
              <p className="mb-3">
                Offline devices should later trigger backend-driven alerts and incident workflows.
              </p>
              <p>
                {source === 'api'
