  ...
  return (
    <AuthenticatedShell contentClassName="max-w-6xl">
      <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="max-w-2xl text-gray-600 dark:text-gray-400">
            Define controller access, metrics collection, alerting policy, and platform behavior
            before connecting the frontend to the full backend and database stack.
          </p>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                This page now mirrors the current local backend profile
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
        {statusCards.map((card) => {
          ...
          return (
            <Card
              key={card.title}
              className="border-gray-200 bg-white/80 shadow-sm dark:border-gray-800 dark:bg-gray-900/80"
            >
            ...
            <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  disabled
                  className="bg-white dark:bg-gray-950 cursor-not-allowed opacity-50"
                />
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-950">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Prepared for PostgreSQL persistence.
                    </p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-950">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Reserved for future WebSocket integration.
                    </p>
                  </div>
                  <Switch defaultChecked />
                </div>
            ...
            <CardContent className="space-y-4 text-sm">
              ...
              <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-900 dark:bg-amber-950/40">
                <p className="font-semibold text-amber-700 dark:text-amber-300">
                  Backend bridge available
                </p>
                <p className="mt-1 text-amber-600 dark:text-amber-400">
                  Devices, topology, flows, dashboard stats, and metrics already exist via the
                  backend API.
                </p>
              </div>
              <div className="rounded-xl border border-violet-200 bg-violet-50 p-4 dark:border-violet-900 dark:bg-violet-950/40">
                ...
                <p className="mt-1 text-violet-600 dark:text-violet-400">
                  PostgreSQL is already prepared for caching, history, and alerts, but the platform
                  does not use every table yet.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-red-200 bg-red-50/80 shadow-sm dark:border-red-900/50 dark:bg-red-950/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-red-700 dark:text-red-300">
                Use reset only when you want to discard controller settings and return to the
      ...
      <div className="mt-8 flex flex-col gap-3 sm:flex-row">
        ...
        <Button variant="outline">Preview Integration</Button>
      </div>
    </AuthenticatedShell>
  );
}
